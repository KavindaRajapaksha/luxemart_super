  ...
  return (
    <div className='container mx-auto'>
      <section className='my-16'>
        ...
        <div className='flex flex-wrap items-center'>
          <div className='w-full md:w-1/2 flex justify-center mb-8'>
            <img src="https://img.freepik.com/free-photo/chef-holding-lettuce-white-background_1368-10199.jpg?t=st=1714747969~exp=1714751569~hmac=1cbf056a91b21e8f13c3ad1c0471c0e1b9231a02faad38ef90c316e83b4cb5f2&w=740"
            alt="AboutImage2"
            className="image-responsive"
      ...
      <section className='my-16'>
        <div className='flex flex-wrap items-center'>
          ...
          <div className='w-full md:w-1/2 flex justify-center mb-8'>
            <img src="https://img.freepik.com/free-photo/high-angle-view-bunch-tomatoes-with-chili-peppers-onion-eggplant-greens-broccoli-garlic-gray-surface-horizontal_176474-5104.jpg?t=st=1714748158~exp=1714751758~hmac=ce4333ac9ef930d4958e9cd1a29705a8b38799e8aee7b1e3304b0e976717f7ee&w=996" 
            alt="AboutImage3" 
            className="image-responsive"
            style={{ maxWidth: '100%', height: 'auto', marginLeft:'32px' }} />
          </div>
